...
import (
	...
	"github.com/emidioreb/mercado-fresco-lerigophers/internal/productBatches"
...
// CreateProductBatch implements product_batches.Service
func (*Service) CreateProductBatch(BatchNumber int, CurrentQuantity int, CurrentTemperature int, InitialQuantity int, ManufacturingHour int, MinimumTemperature int, ProductId int, SectionId int, DueDate time.Time, ManufacturingDate time.Time) (product_batches.ProductBatches, web.ResponseCode) {
	panic("unimplemented")
}

// GetReportSection implements product_batches.Service
func (*Service) GetReportSection(SectionId int) ([]product_batches.ProductsQuantity, web.ResponseCode) {
	panic("unimplemented")
}
