...
import (
	...
	"github.com/emidioreb/mercado-fresco-lerigophers/pkg/repetition"
...
func TestCreateBuyer(t *testing.T) {
	...
	repetitionCharacters256 := repetition.RepetitionCharacters(256)
	repetitionCharacters21 := repetition.RepetitionCharacters(21)
